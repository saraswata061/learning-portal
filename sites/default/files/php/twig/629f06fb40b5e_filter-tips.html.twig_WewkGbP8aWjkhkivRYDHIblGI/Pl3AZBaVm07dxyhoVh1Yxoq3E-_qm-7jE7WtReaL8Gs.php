...
class __TwigTemplate_b340e820a883446d07dffa32ec310535fd194483dad39711fd4e19a0b3db221f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig", "/var/www/html/learning-portal/core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig");
    }
